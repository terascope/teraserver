...
describe('teraserver search analytics module', () => {
    ...
    it('test 500 status codes', () => {
        res.statusCode = 500;
        searchCounterModule.__test_context()._resetCounter();
        searchCounterModule.tokenAndStatusCodeCount(req, res);
        res.statusCode = 200;
        searchCounterModule.tokenAndStatusCodeCount(req, res, 10);
        searchCounterModule.tokenAndStatusCodeCount(req, res, 20);
        res.statusCode = 500;
        counter = searchCounterModule.tokenAndStatusCodeCount(req, res);
    ...
    it('average time is correct', () => {
        res.statusCode = 200;
        searchCounterModule.__test_context()._resetCounter();
        searchCounterModule.tokenAndStatusCodeCount(req, res, 38);
        searchCounterModule.tokenAndStatusCodeCount(req, res, 72);
        searchCounterModule.tokenAndStatusCodeCount(req, res, 12);
        searchCounterModule.tokenAndStatusCodeCount(req, res, 124);
        searchCounterModule.tokenAndStatusCodeCount(req, res, 235);
        const bulkArray = searchCounterModule.__test_context()._bulkRequests();
