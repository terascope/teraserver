...
module.exports = function(appConfig, date_field) {
    ...
    function performSearch(context, req, res, config, fn) {
        if (req.query.size) {
    ...
    function luceneWithHistoryQuery(req, res, indexes, config, fn) {
        ...
        luceneQuery(req, res, indexes, config, fn);
    }
    ...
    function luceneQuery(req, res, index, config, fn) {
        ...
        performSearch({index: index, ignoreUnavailable: true}, req, res, config, fn);
    }
